...
// const layerSnapshot = null as ImageData | null;
    ...
    if (draw.brushFeather > 0) {
        ...
        for (let i = 1; i <= steps; i++) {
            ...
            for (let j = 0; j < existingData.data.length; j += 4) {
                ...
                const newAlpha = stroke.stamp.data[j + 3] / 255;
        ...
        const color = colorToCSS(drawLayer ? drawLayer.foregroundColor : ui.foregroundColor);
