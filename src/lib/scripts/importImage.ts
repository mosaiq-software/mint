            ...
            img.onload = () => {
                ...
                switch (marginSide) {
                    case "left": {
                        ...
                        layer.transform.matrix = layer.transform.matrix.scale(
                            scale,
                            scale,
                        );
                        ...
                        actions.push({
                            ...
                            oldDocument: {
                                id: docs.selected.id,
                                width: docs.selected.width,
                            },
                            newDocument: {
                                id: docs.selected.id,
                                width: docs.selected.width + imgWidth,
                            },
                        });
                    ...
                    case "top": {
                        ...
                        actions.push({
                            ...
                            oldDocument: {
                                id: docs.selected.id,
                                height: docs.selected.height,
                            },
                            newDocument: {
                                id: docs.selected.id,
                                height: docs.selected.height + imgHeight,
                            },
                        });
                        docs.selected.layers.forEach((oldLayer) => {
                    ...
                    case "right": {
                        const scale = layer.canvas.height / img.height;
                        layer.transform.matrix = layer.transform.matrix
                            .translate(docs.selected.width, 0)
                            .scale(scale, scale);
                            ...
                            actions: [
                                {
                                    ...
                                    newDocument: {
                                        id: docs.selected.id,
                                        width: docs.selected.width + widthDiff,
                                    },
                                },
                                {
                                    type: "create",
                    ...
                    case "bottom": {
                        const scale = layer.canvas.width / img.width;
                        layer.transform.matrix = layer.transform.matrix
                            .translate(0, docs.selected.height)
                            .scale(scale, scale);
                            ...
                            actions: [
                                {
                                    ...
                                    newDocument: {
                                        id: docs.selected.id,
                                        height:
                                            docs.selected.height + heightDiff,
                                    },
                                },
                                {
                                    type: "create",
                    ...
                    default: {
                        ...
                        layer.transform.matrix =
                            layer.transform.matrix.translate(layerX, layerY);
                        postAction({
                            type: "create",
                            layer,
                            position: docs.selected.layers.length,
 ...
 */
export function importImageAsNewDoc(
    file: File,
    onSuccess: () => void = () => {},
) {
    const reader = new FileReader();
